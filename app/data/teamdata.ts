...
export const teamData: TeamMember[] = [
  {
    ...
    description: "I am an electrical and computer engineer. With a passion for innovation. I have developed strong skills in Fab Lab and tech space management. However my true passion lies in embedded ML and digital fabrication where I constantly seek ways to incorporate this cutting-edge technology into my work. ",
    image: lidetu,
    type: "alumni",
    socialLinks: [
      { url: "mailto:lidetu.tadesse@aau.edu.et", icon: faEnvelope, iconClass: "w-6 h-6 text-primary dark:text-primary" },
      
      { url: "https://www.linkedin.com/in/lidetu-tadesse/ ", icon: faLinkedin, iconClass: "w-6 h-6 text-primary dark:text-primary" },
    ],
  },
  {
    name: "Kirubel Sentayehu",
    position: "Software engineer",
    description: "Hello there! I am a graduate of computer science. I have a profound interest in AI technologies, particularly reinforcement learning and generative AI. Proficient in Python, Node.js, Next.js, TypeScript, and React.js.During my time at 4K Labs, I actively contributed to the Autonomous car project, where I played a role in controlling the car's movement using a Raspberry Pi 3 and driver board. Additionally, I participated in the Alpha 1S robot hack project, where my responsibilities included decoding the hex code sent from the robot.",
    image: kirusentayehu,
    type: "alumni",
    socialLinks: [
  ...
  },
  {
    ...
    position: "Software engineer",
    description: "I am a Computer Science graduate from Addis Ababa University with an interest in robotics and artificial intelligence.",
    image: dagmawi,
    type: "alumni",
    socialLinks: [
  ...
  },
  {
    ...
    description: "I am an enthusiastic and dynamic mechanical engineer, currently engaged in design and fabrication of 4K Lab projects using digital fabrication tools. ",
    image: akililu,
    type: "member",
    socialLinks: [
  ...
  },
  {
    ...
    description: "I am a computer science student at Addis Ababa University. I am currently involved in creating social media content for 4k Labs social media pages. Additionally, I am learning Adobe Photoshop to design posts for 4k Lab.",
    image: lidya,
    type: "member",
    socialLinks: [
  ...
  },
  {
    ...
    position: "Software engineer",
    description: "I enjoy solving problems with computers. I like making programs that do cool things and learning new stuff to make them even better. I'm always curious and trying to improve. During my time in 4K Labs I was involved in developing a class scheduling application that improves scheduling efficiency.",
    image: abenezer,
    type: "alumni",
    socialLinks: [
