...
const socialMediaLinks = [
  ...
  {
    icon: faInstagram,
    href: "https://instagram.com/4klabs4k?utm_source=qr&igshid=MzNlNGNkZWQ4Mg==",
  },
  { icon: faTwitter, href: "https://twitter.com/4klabs4k" },
  { icon: faFacebook, href: "https://www.facebook.com/4klabs4k/" },
  {
    icon: faWhatsapp,
    href: "https://whatsapp.com/channel/0029VaC9pxn0bIdquIfWZU38",
  },
];
          ...
          <div className="p-6 rounded-lg">
            ...
            <form className="mt-8 space-y-4">
              ...
              <textarea
                placeholder="Message"
                rows={6}
                className="w-full rounded-md px-4 text-sm pt-3"
              ></textarea>
              <button
                type="button"
          ...
          <div>
            ...
            <ul className="flex mt-12 space-x-4">
              {socialMediaLinks.map((socialMedia, index) => (
                <li
                  key={index}
                  className={`h-10 w-10 rounded-full flex items-center justify-center shrink-0 ${socialMedia}`}
                >
                  <a
