                ...
                <div>
                    ...
                    <ul className="mt-12 space-y-8">
                        <li className="flex items-center">
                            ...
                            <a href="mailto:4klabs@aau.edu.et" className="text-sm ml-3">
                                <strong>4klabs@aau.edu.et</strong>
                            </a>
                        </li>
                        <li className="flex items-center">
                        ...
                        <li className="flex items-center">
                            ...
                            <a href="javascript:void(0)" className="text-sm ml-3">
                                <strong>4killo Addis Ababa University</strong>
                            </a>
                        </li>
                    </ul>
