...
const FAQs = () => {
    ...
    return (
        ...
        <div className="md:flex w-full mt-40 mb-6 justify-around items-stretch">
            {/* Left Div - Content */}
            <div className=" flex flex-col justify-between md:w-1/2 p-12 md:order-1 bg-[#EBEBEB]">
                <div>
                ...
                <div className="mt-auto">
                    ...
                    <ul className="mt-12 space-y-8">
                        ...
                        <li className="flex items-center">
                            ...
                            <Link className="text-sm ml-3" href="tel:+1234567890">+1(234)-567-890</Link>
                ...
                <div>
                    {faqs.map((faq, idx) => (
                        <div key={idx} className="border-b border-orange-400 m-8 min-w-lg">
                            ...
                            {expandedIdx === idx && (
                                <div className="text-gray-800 mt-2 py-2" dangerouslySetInnerHTML={{ __html: faq.content }}></div>
                            )}
                        </div>
                    ))}
                </div>
