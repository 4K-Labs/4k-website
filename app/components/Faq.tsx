...
const Faq = () => {
    ...
    return (
        ...
        <div className="md:flex md:flex-row mb-56 h-full w-full py-36 m-auto justify-around items-center self-center">
            {/* Left Div - Content */}
                ...
                <div>
                    {faqs.map((faq, idx) => (
                        <div key={idx} className="border-b border-orange-400 m-8 min-w-lg">
                            ...
                            {expandedIdx === idx && (
                                <div className="text-gray-800 mt-2 py-2">{faq.content}</div>
                            )}
                        </div>
                    ))}
                </div>
